...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String ITEMS_CREATE = "create table "
			+ TABLE_ITEMS + "(" + COLUMN_ID
			+ " integer primary key autoincrement, " + COLUMN_ITEM + " text not null);";
	
	private static final String PERSONS_CREATE = "create table "
	...
	private static final String HISTORY_CREATE = "create table "
			...
			+ " integer primary key autoincrement, " + COLUMN_PERSONID
			+ " text not null, " + COLUMN_ITEMID
			+ " text not null, " + COLUMN_RETURNED + " integer, "
			+ COLUMN_DATE + " text);";
	...
	public void onCreate(SQLiteDatabase database) {
		...
		database.execSQL(PERSONS_CREATE);
